...
const displayRecipeCard = (data) => {
  ...
  data.forEach((recipe) => {
    ...
    return (gridContent += `<article data-id="${recipe.id}" class="recipe-card">
                                    <div class="recipe-card__img-container" style="background-image: url(https://source.unsplash.com/random?${
                                      recipe.name.split(" ")[0]
                                    ...
                                    <div class="recipe-card__text-container">
                                        ...
                                        <div class="recipe-time"><i class="far fa-clock recipe-time__icon"></i> ${
                                          recipe.time
                                        } min</div>
